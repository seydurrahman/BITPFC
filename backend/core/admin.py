...
from .models import AssignMembership, Banner, Gallery, MembershipCategory, NewsRoom,VideoMedia, StudyCenter, Events
...
class EventsAdmin(admin.ModelAdmin):
    list_display = ("title", "event_date", "is_active", "created_at", "updated_at")
